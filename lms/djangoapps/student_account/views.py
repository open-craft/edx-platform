...
def login_and_registration_form(request, initial_mode="login"):
    ...
    context = {
        'data': {
            ...
            'cloudera_hide_sso_in_registration': settings.FEATURES.get('CLOUDERA_HIDE_SSO_IN_REGISTRATION'),
            'cloudera_hide_sso_in_login': settings.FEATURES.get('CLOUDERA_HIDE_SSO_IN_LOGIN'),
        },
