...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "\n      If you have disabilities,\n      you might be eligible for an additional time allowance on timed exams.\n      Ask your course team for information about additional time allowances.\n    ": "\n      If you have disabilities,\n      you might be eligible for an additional time allowance on timed exams.\n      Ask your programme team for information about additional time allowances.\n    ",
    "\n      Proctoring for this course is provided via %(provider_name)s.  Onboarding review, including identity verification, can take 2+ business days.\n    ": "\n      Proctoring for this programme is provided via %(provider_name)s.  Onboarding review, including identity verification, can take 2+ business days.\n    ",
    "\n      To be eligible for credit or the program credential associated with this course, you must pass the proctoring review for this exam.\n\n    ": "\n      To be eligible for credit or the program credential associated with this programme, you must pass the proctoring review for this exam.\n\n    ",
    "\n      Your profile has been established, and you're ready to take proctored exams in this course.\n    ": "\n      Your profile has been established, and you're ready to take proctored exams in this programme.\n    ",
    "Course Id": "Programme Id",
    "Missing required query parameter course_id": "Missing required query parameter course_id",
    "No exams in course {course_id}.": "No exams in programme {course_id}.",
    "No proctored exams in course {course_id}": "No proctored exams in programme {course_id}",
    "Proctored exam {exam_name} in {course_name} for user {username}": "Proctored exam {exam_name} in {course_name} for user {username}",
    "Proctoring Results For {course_name} {exam_name}": "Proctoring Results For {course_name} {exam_name}",
    "Proctoring Review In Progress For {course_name} {exam_name}": "Proctoring Review In Progress For {course_name} {exam_name}",
    "There is no onboarding exam related to this course id.": "There is no onboarding exam related to this programme id.",
    "could not determine the course_id": "could not determine the course_id",
    "courses with active proctored exams": "programmes with active proctored exams",
    "your course": "your programme",
  };
