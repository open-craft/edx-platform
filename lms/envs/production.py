...
COURSE_BLOCKS_API_EXTRA_FIELDS = ENV_TOKENS.get('COURSE_BLOCKS_API_EXTRA_FIELDS', COURSE_BLOCKS_API_EXTRA_FIELDS)
...
AWS_S3_SIGNATURE_VERSION = ENV_TOKENS.get('AWS_S3_SIGNATURE_VERSION')
